 ...
 */
import { EMISSION_KINDS, type EmissionKind } from './types.js';
 ...
 */
export function voiceOf(capability: { readonly canProbe: boolean; readonly encodings?: readonly EmissionKind[] } | undefined): readonly EmissionKind[] {
