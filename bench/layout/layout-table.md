node v22.16.0 · darwin arm64 · 2026-09-07T08:11:14.440Z
...
|---|---:|---:|---|
| clock (a deliberate block) | 40 ms | 40.013 ms | YES |
...
|---:|---:|---|---:|---:|---:|---:|---:|
| 1,000 | 2,919 | 3 × 30 | 0.336 ms | 17.985 ms | 18.273 ms | 159.37 ms | 5.312 ms |
| 10,000 | 29,195 | 1 × 30 | 2.107 ms | 2,259.786 ms | REFUSED | 23,050.568 ms | 768.352 ms |
...
|---:|---:|---:|---:|---:|---:|---:|
| 1,000 | 1.9 MiB | 76.7 MiB | 13.4 MiB | 11.5 MiB | 7 | 59,052 |
| 10,000 | 190.7 MiB | 493.1 MiB | 381.9 MiB | 33.0 MiB | 9 | 5,909,510 |
...
### 3 · quality — is the placement better than a random scatter?
...
195.236 ms at 1,000 nodes over 2,919 edge rows — one cold call (no warm-up): the flowchart, the commit and the column write, on top of the phases above.
