/**
 * X1' acceptance tests — the existential spike for H4.
 *
 ...
 *
 * These tests were written BEFORE the log substrate was finalized and drive it
 * end-to-end (author live -> serialize -> replay into fresh Selection+registry).
 */
